...
P11y0=-vijy(1)*N11*K0*(Vy)/Vx-vijy(1)*N11*K0*omZ0*A1/Vx;                                                                                         
P12y0=-vijy(2)*N12*K0*(Vy)/Vx-vijy(2)*N12*K0*omZ0*A1/Vx;                                                                                         
P21y0=-vijy(3)*N21*K0*(Vy)/Vx+vijy(3)*N21*K0*omZ0*A2/Vx;                                                                                         
P22y0=-vijy(4)*N22*K0*(Vy)/Vx+vijy(4)*N22*K0*omZ0*A2/Vx;                                                                                         
...
fi=fi+X_(2)*(tfinal1-tfinal); if fi*180/3.14<5, kF=7000/Vx^2; else if fi*180/3.14<10, kF=8500/Vx^2; else kF=10000/Vx^2; end; end;                
