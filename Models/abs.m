...
while t<tfinal,                                                                                                                      
X_(1)= Vx*X(2) + 1/M*X(11) + 1/M*X(12) + 1/M*X(13) + 1/M*X(14);                                                                      
X_(2)= -B/I*X(7) + B/I*X(8) - B/I*X(9) + B/I*X(10) + A1/I*X(11) + A1/I*X(12) - ...                                                   
A2/I*X(13) - A2/I*X(14);                                                                                                             
X_(3)= -R/I1*X(7) + 1/I1*L11;                                                                                                        
X_(4)=-R/I1*X(8) + 1/I1*L12;                                                                                                         
X_(5)=-R/I2*X(9) + 1/I2*L21;                                                                                                         
X_(6)=-R/I2*X(10) + 1/I2*L22;                                                                                                        
X_(7)=K11x*R/T11x4*X(3) + (-1)/T11x4*X(7) + 1/T11x4*(-1)*U11x;                                                                       
X_(8)=K12x*R/T12x4*X(4) + (-1)/T12x4*X(8) + 1/T12x4*(-1)*U12x;                                                                       
X_(9)=K21x*R/T21x4*X(5) + (-1)/T21x4*X(9) + 1/T21x4*(-1)*U21x;                                                                       
X_(10)=K22x*R/T22x4*X(6) + (-1)/T22x4*X(10) + 1/T22x4*(-1)*U22x;                                                                     
X_(11)=-K11y/T11y4*X(1) - K11y*A1/T11y4*X(2) - 1/T11y4*X(11);                                                                        
X_(12)=-K12y/T12y4*X(1) -K12y*A1/T12y4*X(2) - 1/T12y4*X(12);                                                                         
X_(13)=-K21y/T21y4*X(1) + K21y*A2/T21y4*X(2) - 1/T21y4*X(13);                                                                        
X_(14)=-K22y/T22y4*X(1) + K22y*A2/T22y4*X(2) - 1/T22y4*X(14);                                                                        
omegazproiz1=(X_(2)-X(2))/dT;                                                                                                        
