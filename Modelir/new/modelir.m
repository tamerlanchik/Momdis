...
% Last Modified by GUIDE v2.5 23-Apr-2020 19:08:56
...
file_name=strcat('momdis', filesep, 'data_', rdb_name, '.mat');
if exist(file_name, 'file')~=0
    exist(file_name, 'file');
    load(strcat('momdis', filesep, 'data_', rdb_name));
    s=size(Data0.Q);
    if s(1)==1
...
set(hObject, 'Value', 1);
load(strcat('momdis', filesep, 'data_',get(hObject, 'Tag')));
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
load(['momdis', filesep, 'data_flag_nd']);
